...
`),U(n,--this.indentLevel),n.push(`))({}),
`),this.visitNamespace(e,r)}makeGlobalImport(e,r,n){let s=this.sb,a=n.type;U(s,this.indentLevel),Pe(r)?s.push(r):(s.push('"'),s.push(ye(r,34)),s.push('": '));let l=this.ensureModuleId(e);zr(a,0)?(s.push(`(
...
`),U(s,--this.indentLevel),s.push("}")),s.push(`,
`)}makeFunctionImport(e,r,n,s=null){let a=this.sb,l=n.signature;if(U(a,this.indentLevel),Pe(r)?a.push(r):(a.push('"'),a.push(ye(r,34)),a.push('"')),kc(l,0)&&!s&&Pe(r))a.push(`: (
...
`);let o=a.length;for(let I=Map_keys(r),T=0,v=I.length;T<v;++T){let S=I[T],F=this.ensureModuleId(S),R=r.get(S);if(U(a,this.indentLevel),Pe(S)?a.push(S):(a.push('"'),a.push(ye(S,34)),a.push('"')),!xI(S)){a.push(": __module"),a.push(F.toString()),a.push(`,
`);continue}let B=a.length;a.push(": Object.assign(Object.create("),S=="env"?a.push("globalThis"):(a.push("__module"),a.push(F.toString())),a.push("), "),S=="env"&&a.push("imports.env || {}, "),a.push(`{
`),++this.indentLevel;let N=0;for(let D=Map_keys(R),W=0,V=D.length;W<V;++W){let O=D[W],X=assert(R.get(O));if(X.kind==5){let re=X,Y=this.getExternalCode(re);(!kc(re.signature,0)||!Pe(O)||Y)&&(this.makeFunctionImport(S,O,X,Y),++N)}else if(X.kind==0){let re=X;(!zr(re.type,0)||!Pe(O))&&(this.makeGlobalImport(S,O,re),++N)}}--this.indentLevel,N?(U(a,this.indentLevel),a.push(`}),
`)):(a.length=B,S=="env"?a.push(": Object.assign(Object.create(globalThis), imports.env || {})"):(a.push(": __module"),a.push(F.toString())),a.push(`,
...
`)),_.push("  const __module"),_.push(F.toString()),_.push(" = imports"),Pe(S)?(_.push("."),_.push(S)):(_.push('["'),_.push(ye(S,34)),_.push('"]')),_.push(`;
...
`)}if(this.needsLowerArray){let I=n.arrayBufferInstance.id,T=n.arrayBufferViewInstance,v=T.nextMemoryOffset+4,S=T.offsetof("buffer"),F=T.offsetof("dataStart"),R=T.offsetof("byteLength"),B=R+4;this.needsSetU32=!0,a.push(`  function __lowerArray(lowerElement, id, align, values) {
...
`);else{let B=this.ensureModuleId(R);U(a,2),Pe(R)?a.push(R):(a.push('"'),a.push(ye(R,34)),a.push('"')),a.push(": __maybeDefault(__import"),a.push(B.toString()),a.push(`),
`),T.push("import * as __import"),T.push(B.toString()),T.push(' from "'),T.push(ye(bI(R),34)),T.push(`";
...
`);let n=this.program.moduleImports;for(let s=Map_keys(n),a=0,l=s.length;a<l;++a){let o=s[a];e.push("  "),Pe(o)?e.push(o):(e.push('"'),e.push(ye(o,34)),e.push('"')),e.push(`: unknown,
